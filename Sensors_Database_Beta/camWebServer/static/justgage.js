...
JustGage = function(config) {
  ...
  obj.config = {
    ...
    titleFontColor: kvLookup('titleFontColor', config, dataset, "#FFFFFF"), //#999999
    ...
    labelFontColor: kvLookup('labelFontColor', config, dataset, "#FFFFFF"), //#b3b3b3
    ...
    labelMinFontSize: kvLookup('labelMinFontSize', config, dataset, 15), // 10
